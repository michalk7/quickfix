...
public class SearchController {
	...
	public String getSearchPage(Model model, @RequestParam("page") Optional<Integer> page, @RequestParam("size") Optional<Integer> size, 
		...
		final int pageSize = size.orElse(1);
		...
		case 7: {
			//all
			expertPage = expertService.findAllByCategoryAndEstate(selectedCategory, userEstate, PageRequest.of(currentPage - 1, pageSize));
			break;
		}
		case 6: {
		...
		case 1: {
			//show all
			expertPage = expertService.findAll(PageRequest.of(currentPage - 1, pageSize));
			break;
		}
		default: {
			expertPage = expertService.findAllByCity(userCity, PageRequest.of(currentPage - 1, pageSize));
			break;
		}
